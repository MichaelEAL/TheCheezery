...
class ProductosActivity : AppCompatActivity() {
    ...
    fun changeTitle(option:String?){
        var titleImg = findViewById<ImageView>(R.id.header_img)
        when(option){
            "coldDrinks" ->{
                titleImg.setImageResource(R.drawable.colddrinks)
               }
            "hotDrinks" ->{
                titleImg.setImageResource(R.drawable.hotdrinks)
                }
            "sweets" ->{
                titleImg.setImageResource(R.drawable.sweets)
                }
            "salties" ->{
                titleImg.setImageResource(R.drawable.salties)
                }
